...
func (x *Order_OrderProduct) GetPrice() string {
	if x != nil {
		return x.Price
	}
	return ""
...
func (x *Order_OrderProduct) GetQuantity() string {
	if x != nil {
		return x.Quantity
	}
	return ""
...
const file_order_proto_rawDesc = "" +
	...
	"\bquantity\x18\x05 \x01(\tR\bquantity\"\xb9\x01\n" +
	...
	"\x05order\x18\x01 \x03(\v2\t.pb.OrderR\x05order2\xa4\x01\n" +
	"\fOrderService\x12:\n" +
